...
#     try:
#         raise TimeoutError("STOP RIGHT THERE!")
...
#     for i in range(progress, len(songs), batch_size):
...
#                     entry['id'] = i + count
#                 data.extend(editedFetch)
#             progress = i + len(fetch)
...
#             return {"data": data, "progress": progress, "songs": songs}
#         time.sleep(2)
